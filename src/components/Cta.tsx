      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div>
              <div
                className={`text-center lg:text-justify font-bold transition-colors group-hover:${theme === 'dark' ? 'text-cyan-400' : 'text-cyan-600'}`}
              >
                Email me
              </div>
              <div
                className={`text-center lg:text-justify text-sm ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'}`}
              >
